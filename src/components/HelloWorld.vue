<template>
  <div class="hello">
    ...
    <el-button type="success" plain><router-link to="/moment">3-4.时间组件 扫码组件 一键复制时间</router-link></el-button>
    ...
    <el-button type="success" plain><router-link to="/button" class="lottie">12.导航栏收合按钮</router-link></el-button>
    <el-button type="success" plain><router-link to="/gradient" class="lottie">13.模仿M1芯片渐变效果</router-link></el-button>
    <!-- 11.全屏 -->
    <quan-ping></quan-ping>
